...
import net.bandit.runes_of_power.item.*;
...
public class ItemRegistry {
    ...
    public static final RegistrySupplier<Item> CURE_INSOMNIA_RUNE = ITEMS.register("cure_rune",
            () -> new CureRune(new Item.Properties().stacksTo(1).arch$tab(TabRegistry.RUNES_TAB).rarity(Rarity.EPIC)));
    public static final RegistrySupplier<Item> STEALTH_RUNE = ITEMS.register("stealth_rune",
            () -> new StealthRune(new Item.Properties().stacksTo(1).arch$tab(TabRegistry.RUNES_TAB).rarity(Rarity.EPIC)));
    public static final RegistrySupplier<Item> BURROW_RUNE = ITEMS.register("burrow_rune",
            () -> new BurrowingRune(new Item.Properties().stacksTo(1).arch$tab(TabRegistry.RUNES_TAB).rarity(Rarity.EPIC)));
    public static final RegistrySupplier<Item> CREATIVE_FLIGHT_RUNE = ITEMS.register("flight_rune",
            () -> new FlightRune(new Item.Properties().stacksTo(1).arch$tab(TabRegistry.RUNES_TAB).rarity(Rarity.EPIC)));
    public static final RegistrySupplier<Item> FIRE_RESISTANCE_RUNE = ITEMS.register("fire_resistance_rune",
            () -> new ResisRune(new Item.Properties().stacksTo(1).arch$tab(TabRegistry.RUNES_TAB).rarity(Rarity.UNCOMMON)));
